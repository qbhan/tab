...
//                    Toast.makeText(context, "000부분 사용을 위해 카메라 권한이 필요합니다.", Toast.LENGTH_LONG).show();
//                } else {
//                    requestPermissions(
...
//permission 새로 추가
        ...
        return v;
        //super.onCreateView(inflater, container, savedInstanceState);  //return 새로 추가
    }
...
//
//                    Toast.makeText(context, "승인이 허가되어 있습니다.", Toast.LENGTH_LONG).show();
//
//                } else {
//                    Toast.makeText(context, "아직 승인받지 않았습니다.", Toast.LENGTH_LONG).show();
//                }
//                return;
//            }
//
